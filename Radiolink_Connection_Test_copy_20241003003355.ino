...
#define SERIAL_PORT_SPEED 115200 // Set the baud rate for serial communication
...
// These functions are called by the interrupts. We send them all to the same place to measure the pulse width
void READ_RC1() { 
